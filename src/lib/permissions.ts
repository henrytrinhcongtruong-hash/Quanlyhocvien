...
export const PERMISSION_TEMPLATES = {
  ...
  lop_truong: {
    ...
    description: "Toàn quyền Điểm danh/Sự kiện/Lịch trực/TKB/Lịch thi - Chỉ xem Học sinh, Sơ đồ, Quỹ & Báo cáo",
    permissions: [
  ...
  to_truong: {
    label: "Tổ trưởng",
    description: "Toàn quyền Điểm danh/Lịch trực/Sự kiện theo tổ - Xem học sinh, Sơ đồ, TKB, Lịch thi & Báo cáo theo tổ",
    permissions: [
      { module: "hoc_sinh", level: "chi_xem", scope: "toan_lop", scopeToIds: [] },
      ...
      { module: "diem_danh", level: "toan_quyen", scope: "theo_to", scopeToIds: [] }, // scopeToIds set khi gán tổ
